...
export const api = {
  ...
  installskill: (spec) => post("/api/skills/install", {spec}),
  removeskill: (name) => post("/api/skills/remove", {name}),
  enableskill: (name, enabled) => post("/api/skills/enable", {name, enabled}),
