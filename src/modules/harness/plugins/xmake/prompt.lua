...
function _section(hasskills)
    local lines = {"# Building with xmake", "",
        ...
        "- `xmake_import` / `xmake_import_write` / `xmake_import_verify` to bring a project",
        "  built with cmake, visual studio, meson or scons into xmake: read the facts first,",
        "  never convert from the original text by eye — and there is an `xmake-porter`",
        "  subagent whose whole purpose is that", "",
